...
<div id="header">
	...
	<img src="${pageContext.request.contextPath }/resources/img/chat/menu2.png" class="smallmenu">
	<span class="moremenu">
	...
	$.ajax({
		...
		success:function(data){
			$(data.list).each(function(i,d){
				...
				if(d.user_id==$("#user_id").val() && msgmessage!=null && msgsysmsg==null){
...
function onClose(){
	$.ajax({
		type:'get',
		data:{'crid':crid,'user_id':user_id},
		url:'${pageContext.request.contextPath }/chat_close',
		dataType:'json',
		success:function(data){
...
$(document).on("mouseenter",".smallmenu",function(){
	$(this).attr("src","${pageContext.request.contextPath }/resources/img/chat/menu1.png");
	$(this).css("cursor","pointer");
});
$(document).on("mouseleave",".smallmenu",function(){
	$(this).attr("src","${pageContext.request.contextPath }/resources/img/chat/menu2.png");
...
$("#menu1").on('click',function(){
	onClose();
	location.href="${pageContext.request.contextPath }/chat_main";
});
//방에 친구초대
